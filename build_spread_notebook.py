"""
Convert fomc_spread_nb.py → fomc_spread_model.ipynb

Rules (same as other build_*_notebook.py scripts):
  • # %% [markdown] → markdown cell
  • # %%            → code cell
  • Strips leading "# " from markdown cell lines
"""
