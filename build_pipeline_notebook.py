"""
Convert fomc_public_pipeline.py → fomc_pipeline_notebook.ipynb
"""
import re, json
from pathlib import Path
from uuid import uuid4

SRC  = Path("fomc_public_pipeline.py")
DEST = Path("fomc_pipeline_notebook.ipynb")
...
nb_cells = [make_cell("code", ROOT_NAV, uuid4().hex[:8])]
