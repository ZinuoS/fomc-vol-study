"""
Convert fomc_backtest.py → fomc_backtest.ipynb

Same rules as build_notebook.py:
  • # %% [markdown]  → markdown cell
  • # %%             → code cell
  • matplotlib.use("Agg") → %matplotlib inline
  • savefig() kept  (saves PNGs to fomc_backtest_output/)
"""
...
SRC  = Path("fomc_backtest.py")
DEST = Path("fomc_backtest.ipynb")
